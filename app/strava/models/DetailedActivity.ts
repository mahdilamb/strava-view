...
} from "./DetailedSegmentEffort";
import type { Lap } from "./Lap";
import { LapFromJSON, LapFromJSONTyped, LapToJSON } from "./Lap";
...
import { SplitFromJSON, SplitFromJSONTyped, SplitToJSON } from "./Split";
...
export function DetailedActivityFromJSONTyped(
  json: any,
  ...
  return {
    ...
    splitsMetric: !exists(json, "splits_metric")
      ? undefined
      : (json["splits_metric"] as Array<any>).map(SplitFromJSON),
    splitsStandard: !exists(json, "splits_standard")
      ? undefined
      : (json["splits_standard"] as Array<any>).map(SplitFromJSON),
    laps: !exists(json, "laps")
      ? undefined
      : (json["laps"] as Array<any>).map(LapFromJSON),
    bestEfforts: !exists(json, "best_efforts")
      ? undefined
      : (json["best_efforts"] as Array<any>).map(DetailedSegmentEffortFromJSON),
  };
}
...
export function DetailedActivityToJSON(value?: DetailedActivity | null): any {
  ...
  return {
    ...
    segment_efforts:
      value.segmentEfforts === undefined
        ? undefined
        : (value.segmentEfforts as Array<any>).map(DetailedSegmentEffortToJSON),
    device_name: value.deviceName,
    embed_token: value.embedToken,
    splits_metric:
      value.splitsMetric === undefined
        ? undefined
        : (value.splitsMetric as Array<any>).map(SplitToJSON),
    splits_standard:
      value.splitsStandard === undefined
        ? undefined
        : (value.splitsStandard as Array<any>).map(SplitToJSON),
    laps:
      value.laps === undefined
        ? undefined
        : (value.laps as Array<any>).map(LapToJSON),
    best_efforts:
      value.bestEfforts === undefined
        ? undefined
        : (value.bestEfforts as Array<any>).map(DetailedSegmentEffortToJSON),
  };
}
