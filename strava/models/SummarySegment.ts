...
export type SummarySegmentActivityTypeEnum =
 ...
 */
export function instanceOfSummarySegment(
  value: object,
): value is SummarySegment {
  return true;
}
...
export function SummarySegmentFromJSONTyped(
  json: any,
...
export function SummarySegmentToJSONTyped(
  value?: SummarySegment | null,
