 ...
 */
export function instanceOfExplorerSegment(
  value: object,
): value is ExplorerSegment {
  return true;
}
...
export function ExplorerSegmentFromJSONTyped(
  ...
  return {
    ...
    elevDifference:
      json["elev_difference"] == null ? undefined : json["elev_difference"],
...
export function ExplorerSegmentToJSONTyped(
  value?: ExplorerSegment | null,
