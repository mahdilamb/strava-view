 ...
 */
export function instanceOfDetailedActivity(
  value: object,
): value is DetailedActivity {
  return true;
}
...
export function DetailedActivityFromJSONTyped(
  ...
  return {
    ...
    bestEfforts:
      json["best_efforts"] == null
        ? undefined
        : (json["best_efforts"] as Array<any>).map(
            DetailedSegmentEffortFromJSON,
          ),
  };
}
...
export function DetailedActivityToJSONTyped(
  value?: DetailedActivity | null,
  ...
  return {
    ...
    segment_efforts:
      value["segmentEfforts"] == null
        ? undefined
        : (value["segmentEfforts"] as Array<any>).map(
            DetailedSegmentEffortToJSON,
          ),
    device_name: value["deviceName"],
    embed_token: value["embedToken"],
    splits_metric:
      value["splitsMetric"] == null
        ? undefined
        : (value["splitsMetric"] as Array<any>).map(SplitToJSON),
    splits_standard:
      value["splitsStandard"] == null
        ? undefined
