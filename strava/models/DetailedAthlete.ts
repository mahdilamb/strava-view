 ...
 */
export function instanceOfDetailedAthlete(
  value: object,
): value is DetailedAthlete {
  return true;
}
...
export function DetailedAthleteFromJSONTyped(
  ...
  return {
    ...
    followerCount:
      json["follower_count"] == null ? undefined : json["follower_count"],
    friendCount:
      json["friend_count"] == null ? undefined : json["friend_count"],
    measurementPreference:
      json["measurement_preference"] == null
        ? undefined
...
export function DetailedAthleteToJSONTyped(
  value?: DetailedAthlete | null,
